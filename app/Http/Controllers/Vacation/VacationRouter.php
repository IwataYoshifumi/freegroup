...
use App\Http\Controllers\Vacation\JsonController;
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    static public function route() {
        ...
        Route::namespace( 'Vacation' )->prefix( '/vacation' )->name( 'vacation.' )->group(function () { 
                ...
                Route::get(  '/application/show_m',                'ApplicationController@show_m'   )->name('application.show_m'   );
                ...
                Route::middleware( ['auth:admin'] )->group( function() {
                        ...
                        // 取得完了済み休暇取得の削除                
                        Route::get(  '/application/select_delete_complete',         'ApplicationController@select_delete_complete'  )->name( 'application.selct_delete_complete'  );
                        Route::get(  '/application/{application}/delete_complete',  'ApplicationController@delete_complete'  )->name( 'application.delete_complete'  )->where( 'application', '[0-9]+');
                        Route::post( '/application/{application}/delete_complete',  'ApplicationController@deleted_complete' )->name( 'application.deleted_complete' )->where( 'application', '[0-9]+');
                ...
                config(['vacation.application.create'      => '休暇申請',
                        ...
                        'vacation.application.delete_complete' => '取得完了済み休暇　取り下げ',
                ...
                Route::middleware([ 'auth:user' ])->group( function() {
                        ...
                        Route::get( '/approval/monthly',                'ApprovalController@monthly'    )->name( 'approval.monthly'  );
                });
                ...
                config(['vacation.approval.index'              => '承認一覧',
                        'vacation.approval.select'             => '承認業務（休暇申請選択）',
                        'vacation.approval.show'               => '承認業務内容',
                        'vactaion.approval.approve'            => '承認（確認）',
                        'vacation.approval.approved'           => '承認（完了）',
                        'vacation.approval.reject'             => '休暇申請却下（確認）',
                        'vacation.approval.rejected'           => '休暇申請却下（完了）',
                        'vacation.approval.monthly'            => '承認業務（月表示）',
                        ]);
    ...
    static public function route_common() {
        ...
        //　休暇検索
        //
        Route::get( '/common/monthly',     'CommonController@monthly'    )->name( 'common.monthly' );  // 月表示
        ...
        Route::get( '/common/how_many_days_get_for_paidleave', 
                        'CommonController@howManyDaysGetForPaidleave' )
                        ->name( 'common.how_many_days_get_for_paidleave' );  //　有給取得日数検索
        Route::get( '/common/how_many_days_get_for_paidleave/csv', 
                        'CommonController@howManyDaysGetForPaidleaveCSV' )
                        ->name( 'common.how_many_days_get_for_paidleave.csv' );
        ...
        config(['vacation.common.vacation'          => '休暇取得状況',
                ...
                'vacation.common.monthly'       => '休暇検索（月表示）',
                ]);
