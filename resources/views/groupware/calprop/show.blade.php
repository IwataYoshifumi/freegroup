            ...
            <div class="card">
                ...
                <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <label for="dept_id" class="col-md-4 col-form-label text-md-right m-1">カレンダー表示名・色設定</label>
                            ...
                            @if( $calendar->not_use )
                                ...
                                <div class="col-md-6 m-1"><span class="alert-danger p-2 text-dark">新規予定追加不可</span></div>
                            @endif

                            @if( $calendar->disabled )
                                <label for="dept_id" class="col-md-4 col-form-label text-md-right m-1">【管理者設定】</label>
                                <div class="col-md-6 m-1"><span class="alert-danger p-2 text-dark">予定修正不可・Googleカレンダー同期不可</span></div>
                            @endif
                            
                            <label for="dept_id" class="col-md-4 col-form-label text-md-right m-1">【個人設定】作成予定変更権限（初期値）</label>
                            <div class="col-md-6 m-1">{{ $permissions[ $calprop->default_permission ] }}</div>

                            @if( $calprop->not_use and ! $calendar->not_use )
                                <label for="dept_id" class="col-md-4 col-form-label text-md-right m-1">【個人設定】</label>
                                <div class="col-md-6 m-1"><span class="alert-warning p-2 text-dark">新規予定追加しない</span></div>
                            @endif

                            @if( $calprop->hide )
                                <label for="dept_id" class="col-md-4 col-form-label text-md-right m-1">【個人設定】</label>
                                <div class="col-md-6 m-1"><span class="alert-warning p-2 text-dark">予定を表示しない</span></div>
                            @endif

                            @if( $calprop->is_filled_GoogleConfig() )
                                @if( $calprop->google_sync_on )
                                    <label for="dept_id" class="col-md-4 col-form-label text-md-right m-1">Google同期</label>
                                    <div class="col-md-6 m-1">
                                ...
                                <div class='collapse col-12' id="google_sync_config">
                                    <div class="row">
                                        <div class="col-4 m-1 text-right">Googleカレンダー同期</div>
                                            <div class="col-5 m-1">
                                        ...
                                        @if( 1 or $calprop->google_sync_on )         
                                            ...
                                            <div class="col-4 m-1 text-right">同期確認</div>
                                            <div class="col-7 m-1">
                                                @if( $calprop->google_sync_check ) <span class='alert-primary text-primary font-weight-bold p-1'>同期ＯＫ</span>
                                                @elseif( is_null( $calprop->google_updated_at ))  
                                                    <span class='alert-warining font-weight-bold p-1'>未確認</span> 
                                                @else
                                            ...
                                            <div class="col-4 m-1 text-right">Googleカレンダー同期日時</div>
                                            <div class="col-7 m-1">
