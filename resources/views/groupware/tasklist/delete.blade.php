...
$tasks_num = $tasklist->tasks()->count();
        ...
        <div class="col-md-8">
            ...
            <div class="card">
                ...
                <div class="card-body">
                        ...
                        @if( $tasks_num )
                            <div class="alert-warning col-11">このタスクリストには{{ $tasks_num }} 件のタスクが登録されています。</div>
                            <div class="alert-warning col-11">タスクリストを削除することで、これらのタスクも全て削除されます。</div>
                            <div class="alert-warning col-11">対応履歴や顧客対応履歴を残すためにも、タスクリストを「無効化」するだけで、削除しないことをオススメします。</div>
                        @else
                            <div class="alert-warning col-11">このタスクリストに紐づけられているタスクはありません。</div>
                        @endif
                        ...
                        <div class="form-group row">
                            @if( Route::currentRouteName() == "groupware.tasklist.delete" )
                                <form id="delete_form" method="POST" action="{{ url()->current() }}" class="col-12">
                                    ...
                                    <div class="row p-1">
                                        <div class="col-2"></div>
                                        <div class="col-9">
                                            <label for="delete_comfirm_1" class="font-weight-bold w-90 ">このタスクリストに紐づけされている全てのタスクも削除されます</label>
                                ...
                                <div class="col-2"></div>
                                <div class="col-9">
                                    <a class="btn btn-danger text-white ml-5" onClick="submit_button();">タスクリスト削除</a>
                                    {{ BackButton::form() }}
                                </div>
                            @endif
