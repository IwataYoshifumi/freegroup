...
<div class="form-group row no-gutters">
    <label for="dept_id" class="col-12 col-md-4 my_label text-md-right m-1">タスクリスト名</label>
    <div class="col-12 col-md-6 m-1">
        {{ $tasklist->name }}
    </div>
    
    <label for="name" class="col-12 col-md-4 my_label text-md-right m-1">タスクリストアクセス権限</label>
    ...
    <label for="dept_id" class="col-12 col-md-4 my_label text-md-right m-1">タスクリスト公開種別</label>
    <div class="col-12 col-md-6 m-1">
        {{ TaskList::getTypes()[$tasklist->type] }}
    </div>
    
    <label for="dept_id" class="col-12 col-md-4 my_label text-md-right m-1">タスク　変更権限初期値</label>
    <div class="col-12 col-md-6 m-1">
        {{ $permissions[$tasklist->default_permission] }}
    </div>

    @if( $tasklist->not_use )
        <label for="dept_id" class="col-12 col-md-4 my_label text-md-right m-1">新規タスク追加</label>
        <div class="col-12 col-md-6 m-1 alert-danger">
            否（不可）
        </div>
    @endif
    @if( $tasklist->disabled ) 
        <label for="dept_id" class="col-12 col-md-4 my_label text-md-right m-1">タスクリスト無効化</label>
        <div class="col-12 col-md-6 m-1 alert-danger">
            無効化中<br>
