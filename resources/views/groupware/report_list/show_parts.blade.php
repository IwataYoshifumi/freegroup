...
<div class="form-group row no-gutters">
    <label for="dept_id" class="col-12 col-md-4 my_label text-md-right m-1">日報リスト名</label>
    <div class="col-12 col-md-6 m-1" style="{{ $report_prop->style() }}">
        {{ $report_list->name }}
    </div>
    
    <label for="name" class="col-12 col-md-4 my_label text-md-right m-1">日報リストアクセス権限</label>
    <div class="col-12 col-md-6">
        {{ $authority }}
    </div>
    
    <label for="dept_id" class="col-12 col-md-4 my_label text-md-right m-1">備考</label>
    <div class="col-12 col-md-6 m-1">
        {{ $report_list->memo }}
    </div>

    <label for="dept_id" class="col-12 col-md-4 my_label text-md-right m-1">アクセスリスト</label>
    <div class="col-12 col-md-6 m-1">
        {{ $access_list->name }}
    ...
    <label for="dept_id" class="col-12 col-md-4 my_label text-md-right m-1">日報　リスト公開種別</label>
    <div class="col-12 col-md-6 m-1">
        {{ ReportList::getTypes()[$report_list->type] }}
    </div>
    
    <label for="dept_id" class="col-12 col-md-4 my_label text-md-right m-1">日報　変更権限　初期値</label>
    <div class="col-12 col-md-6 m-1">
    ...
    @if( $report_list->not_use )
        <label for="dept_id" class="col-12 col-md-4 my_label text-md-right m-1">新規日報追加</label>
        <div class="col-12 col-md-6 m-1 alert-danger">
            否（不可）
        </div>
    @endif
    @if( $report_list->disabled ) 
        <label for="dept_id" class="col-12 col-md-4 my_label text-md-right m-1">日報リスト無効化</label>
        <div class="col-12 col-md-6 m-1 alert-danger">
            無効化中<br>
