    ...
    <div class="container border border-primary bg-light shadow align-middle p-3">
        <div class="row">
            ...
            <div class="row container">
                ...
                {{ Form::select( 'find[pagination]', [ 1=> 1, 10 => 10, 20 => 20, 30 => 30, 50 => 50, 100 => 100 ] ,
        ...
        <div class='col-12 col-lg-3'>
            <div class="col-12">有給取得日数＜＝</div>
            {{ Form::number( 'find[num]', old( 'find[num]', ( isset( $find['num'] )) ? $find['num'] : '' ), [ 'class' => 'form-control col-12' ] ) }}
        </div>
